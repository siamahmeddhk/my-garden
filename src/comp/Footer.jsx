...
//   return (
//     <footer className="bg-base-200 text-base-content pt-8 px-6 md:px-12 lg:px-24">
...
//             <p>Email: <a href="mailto:support@gardensite.com" className="hover:underline">support@gardensite.com</a></p>
//           </address>
//         </div>
...
//             <a href="#" className="link link-hover hover:text-green-600 transition">Terms of Service</a>
//             <a href="#" className="link link-hover hover:text-green-600 transition">Privacy Policy</a>
//           </nav>
//         </div>
...
//               href="#"
//               aria-label="Twitter"
//               className="bg-green-500 p-3 rounded-full hover:bg-green-600 transition flex items-center justify-center"
//             >
...
//       {/* Bottom Line */}
//       <div className="mt-10 text-center text-sm text-gray-500 border-t border-base-300 py-6">
